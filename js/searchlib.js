...
(function() {
    ...
    var SearchInfoWindow =
        ...
        this._opts.mkmsg = opts.mkmsg || 'text'; //是否开启发送到手机
    }
      ...
      _dispatchEvent: function(instance, type, opts) {
        ...
        _createSearchTemplate: function() {
            if (!this._div) {
                ...
                var template = [
                    '<div class="BMapLib_bubble_top" style="display:none;">',
                        '<div class="BMapLib_bubble_title" id="BMapLib_bubble_title' + this.guid + '"></div>',
                        '<div class="BMapLib_bubble_tools">',   
                          '<div class="BMapLib_sendToPhone" style="height: 15px;width: 15px;" title="发送到手机" id="BMapLib_sendToPhone' + this.guid + '">',
                          '</div>',                                                      
                        '</div>',
                    '</div>',
                    '<div class="BMapLib_bubble_center">',
                        ...
                        '<div class="BMapLib_nav" id="BMapLib_nav' + this.guid + '">',
                            '<ul class="BMapLib_nav_tab" style="display:none;" id="BMapLib_nav_tab' + this.guid + '">', //tab选项卡
                            ...
                            '<ul class="BMapLib_nav_tab_content">', //tab内容
                                ...
                                '<li id="BMapLib_transBox' + this.guid + '" style="display:none">',
                                    '<table width="100%" align="center" border=0 cellpadding=0 cellspacing=0>',
                                        '<tr><td width="30" style="padding-left:8px;"><div id="BMapLib_stationText' + this.guid + '">起点</div></td><td><input id="BMapLib_trans_text' + this.guid + '" class="BMapLib_trans_text" type="text" maxlength="100" autocomplete="off"></td><td width="106" style="padding-left:7px;"><input id="BMapLib_search_bus_btn' + this.guid + '" type="button" value="公交" class="iw_bt BMapLib_search_bus_btn0" style="margin-right:5px;"><input id="BMapLib_search_drive_btn' + this.guid + '" type="button" class="iw_bt BMapLib_search_drive_btn0" value="驾车"></td></tr>',
                                    '</table>',
                                '</li>',
                            '</ul>',
                        '</div>',
                    '</div>',
                    '<div class="BMapLib_bubble_bottom" style="display:block;">',
                      '<a class="send-tel" onclick="openTel('+ "'" + this._opts.mkmsg + "',"  + 'this' + ')" href="javascript:void(0);">发送到手机</a>',
                    '</div>',
